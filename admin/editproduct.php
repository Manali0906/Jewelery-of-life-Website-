...
if (isset($_POST['updatepro'])) {
	...
	if($result = mysqli_query($link,"UPDATE products SET pName='$_POST[pname]',price='$_POST[price]',description='$_POST[descri]',available='$_POST[available]',item='$_POST[item]' WHERE id='$epid'")){
